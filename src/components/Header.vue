...
<nav class="navbar navbar-expand-sm navbar-light bg-light" role="navigation">
  <div class="container">
    <router-link to="/" class="navbar-brand mr-auto"><img src="../assets/images/mamon-logo.svg" alt="Logo"></router-link>
    <button
    ...
    <div class="collapse navbar-collapse" id="navbarTop" :class="{show: isNavOpen}">
      ...
      <ul class="nav navbar-nav">
        ...
        <li>
          <router-link to="/cart" class="btn btn-warning navbar-btn" tag="button">
            Корзина <span class="badge badge-light">{{ numItems }} ($ {{ cartValue }})</span>
          </router-link>
        </li>
      </ul>
    </div>
